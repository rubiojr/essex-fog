#h Getting started with Fog and OpenStack Essex 
#
...
#
# List currently available keypairs with:
#
#     nova keypair-list
#
...
# You can also check the status of the server with:
#
#     nova list
#     
#     +--------------------------------------+-----------------+--------+-------------------+
...
##h Associate a public IP to the server
...
##h Cleanup or regret it, @geemus dixit
#
ip.destroy
server.destroy
